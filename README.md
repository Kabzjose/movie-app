...
**Getting your keys:**
- **Gemini** — free at [aistudio.google.com](https://aistudio.google.com) → Get API Key. No credit card needed, 1,500 requests/day free.
- **TMDB** — free at [themoviedb.org/settings/api](https://www.themoviedb.org/settings/api) → Create account → Request API key.
...
- [ ] Watchlist — save movies to a personal list
- [ ] Movie detail page — full cast, trailer, similar titles
- [ ] Auth — persist watchlist across sessions
